        ...
        return (
            ...
            >
                <AlertDialogTrigger
                    ...
                    asChild>
                    {typeof trigger === "string" ? <button className={cn(buttonVariants({ variant: "outline" }), className)}>{trigger}</button> : trigger}
                </AlertDialogTrigger>
                <AlertDialogContent>
                    <AlertDialogHeader>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel variant={cancelVariant} size={buttonSize}>{cancelText}</AlertDialogCancel>
                        <AlertDialogAction variant={actionVariant} size={buttonSize}>{actionText}</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialogRoot>
        )
